    ...
    <SafeAreaView style={[styles.container,{ backgroundColor:SURFACE_BG }]} edges={["top","bottom"]}>
      ...
      <View style={styles.controls}>
        ...
        <FlatList
          ...
          renderItem={({item:c})=>{
            ...
            return (
              <Pressable onPress={()=>setCategory(c)} style={[styles.filterChip,{ backgroundColor: active?PRIMARY:GREY_BG }]}>
        ...
        <FlatList
          ...
          renderItem={({item})=>{
            ...
            return(
              <Pressable onPress={()=>setStatusFilter(item.key)} style={[styles.filterChip,{ backgroundColor: active?PRIMARY:GREY_BG }]}>
      ...
      <Animated.View style={{ flex:1, opacity:fadeAnim }}>
        <FlatList
          ...
          renderItem={({item})=><ForumRow forum={item} cardBg={CARD_BG} textPrimary={TEXT_PRIMARY} textSecondary={TEXT_SECONDARY}/>}
...
function ForumRow({
  ...
  useEffect(()=>{
    const unsub=onSnapshot(collection(db,"forums",forum.id,"comments"),snap=>setComments(snap.size));
    return unsub;
  },[forum.id]);
  ...
  return(
    ...
    >
      ...
      <View style={styles.metaRow}>
        ...
        <View style={[styles.badge, forum.isActive?styles.activeBadge:styles.inactiveBadge]}>
