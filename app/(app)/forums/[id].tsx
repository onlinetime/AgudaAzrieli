...
export default function ForumDetails() {
  ...
  // forum title/direction based on content
  const titleRTL = forum ? isHebrew(forum.title) : uiRTL;
  const descRTL  = forum && forum.description ? isHebrew(forum.description) : uiRTL;
          ...
          {comments.map(c => {
            ...
            return (
              <View key={c.id} style={[styles.comm,{ backgroundColor:CARD_BG }]}>
                ...
                {/* text align by content language */}
