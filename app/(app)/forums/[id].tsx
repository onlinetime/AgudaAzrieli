...
interface ForumDoc {
  ...
  /* קיימים גם isActive / isPinned / isApproved – כאן לא חובה להצגה */
}
...
export default function ForumDetails() {
  ...
  const addComment = async () => {
    ...
    /* שם מלא מה־users → אחרת displayName/Fallback */
        ...
        >
          ...
          <View style={[styles.forumCard, { backgroundColor: CARD_BG, borderColor: ACCENT }]}>
            <Text
              style={[
                styles.meta,
                { color: TEXT_SECONDARY, textAlign: uiRTL ? "right" : "left" }
              ]}
            >
          ...
          {comments.map(c => {
            ...
            return (
              <View key={c.id} style={[styles.comm, { backgroundColor: CARD_BG }]}>
                {/* header (שם + תאריך) תמיד לפי uiRTL */}
                ...
                {/* טקסט התגובה – מיקום לפי שפת התוכן */}
                <Text
                  style={[
                    styles.commTxt,
